...
const Pricing = () => {
  return (
    <section class="bg-white dark:bg-gray-900 font-outfit">
        <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-24">
            ...
            <div class="space-y-8 flex flex-col gap-y-6 lg:space-y-0 relative z-20">
                ...
                <div className='flex lg:flex-row flex-col gap-x-6 items-center justify-center w-full'>
                    ...
                    <div class="flex flex-col w-full lg:w-[48%] p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                        ...
                        <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">Precision for MATHCOUNTS Triumphs</p>
                    ...
                    <div
                        ...
                        <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">Navigate AMC with Expert Guidance</p>
                        <div class="flex items-baseline justify-center my-8">
                ...
                <div className='flex lg:flex-row flex-col gap-6 items-center justify-center w-full'>
                    ...
                    <div class="flex flex-col w-full lg:w-[48%] p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                        ...
                        <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">AIME Excellence, Step by Step</p>
                        <div class="flex items-baseline justify-center my-8">
                    ...
                    <div
                        ...
                        <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">Olympiad Mastery, Guided Success</p>
                        <div class="flex items-baseline justify-center my-8">
