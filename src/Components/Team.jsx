...
const Team = () => {
  return (
    <div class="py-20 bg-gray-50 font-fig">
    <div class="container mx-auto px-6 md:px-12 xl:px-32">
        <div class="mb-16 text-center">
            <h2 class="mb-4 text-center five-title text-gray-900 font-bold">Tutors <span className="text1">With Qualifications</span></h2>
            <p class="text-gray-600 paragraph-responsive lg:w-8/12 lg:mx-auto">
                Are tutors are not only very knowledgeable in their subjects, but also have scored and placed nationally and internationally! 
            </p>
        </div>
        <div class="grid gap-12 items-center md:grid-cols-3">
            <div class="space-y-4 text-center flex flex-col items-center">
                ...
                <div className='flex gap-x-2'>
                    <div class="block text-sm text-white font-outfit py-2 w-max rounded-md px-6 bg1">USAMO Qualifier</div>
                    <div class="block text-sm text-white font-outfit py-2 w-max rounded-md px-6 bg1">CMO Qualifier</div>
                </div>
                <div>
            ...
            <div class="space-y-4 text-center flex flex-col items-center">
                ...
                <div className='flex gap-x-2'>
                    <div class="block text-sm text-white font-outfit py-2 w-max rounded-md px-6 bg1">USAMO Qualifier</div>
                    <div class="block text-sm text-white font-outfit py-2 w-max rounded-md px-6 bg1">AMC12 Perfect Scorer</div>
                </div>
                <div>
            ...
            <div class="space-y-4 text-center flex flex-col items-center">
                <img class="w-64 h-64 mx-auto object-cover rounded-xl md:w-40 md:h-40 lg:w-80 lg:h-64" 
                    ...
                    <div className='flex gap-x-2'>
                        <div class="block text-sm text-white font-outfit py-2 w-max rounded-md px-6 bg1">USAJMO Qualifier</div>
                        <div class="block text-sm text-white font-outfit py-2 w-max rounded-md px-6 bg1">USACO Platinum</div>
                    </div>
                <div>
