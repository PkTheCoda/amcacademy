...
const Hero = () => {
  return (
    <>
      <div className="font-quicksand bg-cover pb-20 lg:pt-0 pt-10 bg-center flex relative lg:flex-row flex-col gap-y-10 bg-stone-50"
              ...
              <div className='w-11/12 flex flex-col gap-y-4'>
                  ...
                  <div className='flex flex-col gap-y-1'>
                    ...
                    <h1 className='seven-title font-bold tracking-tight'>
                        <span className="main-gradient md:block">High Quality, Personal</span> Math Tutoring
                    </h1>
                  </div>
                ...
                <div class="relative max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-8">
                    <div class="max-w-5xl mx-auto flex flex-col gap-y-2">
                        <dl class="rounded-lg grid pb-4 md:pb-0 min-[400px]:grid-cols-2 md:grid-cols-4 lg:grid-cols-2 gap-4">
                            <div class="bg-white rounded-md shadow-md flex flex-col justify-center p-6 px-2 lg:px-10 text-center border-b border-gray-100 sm:border-0 sm:border-r">
                            ...
                            <div
                            class="bg-white rounded-md shadow-md flex flex-col justify-center p-6 text-center border-t border-b border-gray-100 sm:border-0 sm:border-l sm:border-r">
                            ...
                            <div class="bg-white rounded-md shadow-md flex flex-col justify-center p-6 text-center border-t border-gray-100 sm:border-0 sm:border-l">
                                <dt class="order-2 mt-2 text-lg font-medium leading-6 text-gray-500">
                                    CMO Qualifiers
                                </dt>
                                <dd class="order-1 text-5xl font-extrabold leading-none main-gradient">
